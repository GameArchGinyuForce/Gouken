...
class MoveMultipeerSession: NSObject, ObservableObject {
    private let serviceType = "move-messenger"
...
extension MoveMultipeerSession: MCNearbyServiceAdvertiserDelegate {
...
extension MoveMultipeerSession: MCNearbyServiceBrowserDelegate {
...
extension MoveMultipeerSession: MCSessionDelegate {

...
class Character {
    ...
    init(withName name : CharacterName, underParentNode parentNode: SCNNode, onPSide side: PlayerType, playerID: MCPeerID?, components : [GKComponent] = [], withManager : EntityManager) {
